                        ...
                        <form  action="/post/{{$post->id}}" method="POST">
                            ...
                            <div>
                                ...
                                <x-input id="metai" class="block mt-1 w-full"
                                 type="date" name="Metai" value="{{$post->Metai}}" required autofocus />
                            </div>
                            ...
                            <div class="mt-4">
                                ...
                                <x-input id="salis" class="block mt-1 w-full"
                                 type="text" name="Salis" value="{{$post->Salis}}" required />
                            </div>
                            ...
                            <div class="mt-4">
                                ...
                                <x-input id="universitetas" class="block mt-1 w-full"
                                 type="text" name="Universitetas" value="{{$post->Universitetas}}" required />
                            </div>
